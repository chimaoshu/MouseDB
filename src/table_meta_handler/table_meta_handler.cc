...
const json &TableMetaHandler::get_table_meta() { return table_meta_; }
...
void TableMetaHandler::set_new_hot_data_file_name(
    const string &new_hot_data_file_name) {
  table_meta_["hot_data"]["new"] = new_hot_data_file_name;
}

void TableMetaHandler::set_new_cold_data_file_name(
    const string &new_cold_data_file_name) {
...
list<int>
TableMetaHandler::get_column_orders_by_names(const list<string> &column_names) {
